export default function TermsOfServiceContent() {
  return (
    <div className="p-8">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Publish Publish Publish.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Publish Publish Publish,
            accessible from{" "}
            <a
              href="https://www.publishpublishpublish.xyz"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.publishpublishpublish.xyz
            </a>
          </p>
        </li>
        <li>
      ...
      <h2 className="text-xl font-bold">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
      <p>
      ...
      <h2 className="text-xl font-bold">Disputes Resolution</h2>
      <p>
      ...
      <h2 className="text-xl font-bold">For European Union (EU) Users</h2>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which You are
        resident.
      </p>
      <h2 className="text-xl font-bold">United States Legal Compliance</h2>
      <p>
      ...
      <h2 className="text-xl font-bold">Severability and Waiver</h2>
      ...
      <h2 className="text-xl font-bold">Translation Interpretation</h2>
      <p>
      ...
      <h2 className="text-xl font-bold">Changes to These Terms and Conditions</h2>
      <p>
      ...
      <ul>
        <li>By email: matt@mattstrick.com</li>
      </ul>
    </div>
  );
}
